...
import com.example.kotlib.databinding.FragmentVariablesBinding


class Variables : Fragment() {
    private lateinit var _binding: FragmentVariablesBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.backButton.setOnClickListener {
            navCon.navigate(R.id.action_variables_to_homePageFragment)
        }
}}